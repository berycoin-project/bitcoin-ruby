...
* Bitcoin::Berycoin implements all the berycoin-specific differences
...
== Installation
 ...
 gem install bitcoin-ruby // this will install the wrong repo for berycoin, use github
 # OR
 gem install eventmachine
 gem install bundler
 gem install json
 git clone https://github.com/berycoin-project/insight-ruby.git; cd insight-ruby; bundle install
 gem build insight-ruby.gemspec
 gem install ./insight_bitpay-0.0.8.gem
 git clone https://github.com/berycoin-project/bitcoin-ruby.git; cd bitcoin-ruby; bundle install
 gem build bitcoin-ruby.gemspec
 gem install ./bitcoin-ruby-0.0.18.gem
...
* +scrypt+ to use a much faster scrypt hash implementation for Berycoin

If you would like to install using Bundler, put it in your Gemfile and run bundle install
 gem 'bitcoin-ruby', git: 'https://github.com/berycoin-project/bitcoin-ruby', branch: 'master', require: 'bitcoin'
